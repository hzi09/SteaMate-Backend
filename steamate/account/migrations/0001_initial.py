    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preferred_game', models.ManyToManyField(related_name='preferred_game', to='account.game')),
                ('preferred_genre', models.ManyToManyField(related_name='preferred_genre', to='account.genre')),
